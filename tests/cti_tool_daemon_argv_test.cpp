...
int main(int argc, char *argv[]) {
    // set up app
    auto const  appArgv = createSystemArgv(argc, argv, {"./support/hello"});
    ...
    testSocketDaemon(sessionId, "./support/one_socket", extra_argv, {}, "1");
    testSocketDaemon(sessionId, "./support/one_socket", extra_argv, extra_env, "1");
    testSocketDaemon(sessionId, "./support/one_socket", {}, extra_env, "1");
